...
import org.xper.robot.renderer.RobotPerspectiveRenderer;
...
public class GeneralConfig {
	...
	@Bean
	public RobotDbUtil robotDbUtil() {
		RobotDbUtil util = new RobotDbUtil();
...
//		source.setUngetBehavior(UngetPolicy.TAIL);
	...
	// *** added by SHS ***  
	  ...
	  @Bean 
	   public RobotPerspectiveRenderer experimentGLRenderer () {
		  RobotPerspectiveRenderer renderer = new RobotPerspectiveRenderer(); 
	   	  renderer.setDistance(classicConfig.xperMonkeyScreenDistance());
		  renderer.setDepth(classicConfig.xperMonkeyScreenDepth());
		  renderer.setHeight(classicConfig.xperMonkeyScreenHeight());
