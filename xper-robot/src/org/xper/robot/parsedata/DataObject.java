package org.xper.robot.parsedata;
...
//	}
	...
	public void setSpikesPerSec(List<Double> spikesPerSec) {
		...
		setAvgFR(RobotMathUtil.mean(spikesPerSec));
		setStdFR(RobotMathUtil.std(spikesPerSec));
	}
	...
	public void setBkgdSpikesPerSec(List<Double> bkgdSpikesPerSec) {
		...
		setBkgdAvgFR(RobotMathUtil.mean(bkgdSpikesPerSec));
		setBkgdStdFR(RobotMathUtil.std(bkgdSpikesPerSec));
	}
