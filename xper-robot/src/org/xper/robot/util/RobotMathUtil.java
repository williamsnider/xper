...
public class RobotMathUtil {
	...
	public static double randBoundedGauss(double sigma, double mu, double vMin, double vMax) {
		double out;
		do { out = RobotMathUtil.randGauss(sigma,mu);
...
//	    }
	...
	public static boolean anyInBoundingBox(double[][] poly,double[]...pts) {
		...
		double maxX = RobotMathUtil.max(0,poly);
		double minX = RobotMathUtil.min(0,poly);
		double maxY = RobotMathUtil.max(1,poly);
		double minY = RobotMathUtil.min(1,poly);
