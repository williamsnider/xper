...
public class RobotBatchTaskDoneCache extends BatchTaskDoneCache {

	DbUtil dbUtil = super.getDbUtil();
	TimeUtil timeUtil;
	
	public RobotBatchTaskDoneCache(int batchSize) {
		super(batchSize);
	...
	public void put(ExperimentTask task, long timestamp, boolean partial) {
		...
		// also need to change/addto SachTrialExperimentUtil, AlexDbUtil... ugh!
