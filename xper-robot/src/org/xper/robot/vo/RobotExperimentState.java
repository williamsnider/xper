 ...
 *
 */
public class RobotExperimentState extends SlideTrialExperimentState {
	@Dependency
	...
	public RobotExperimentState () {
	}
	
	public int getNumSlidesPerTrial() {
		return 1;  // RobotExptSpec.fromXml(getCurrentTask().getStimSpec()).getStimObjIdCount();
		
	}
	
//	public int getNumSlidesPerTrial() {
//		return RobotExptSpec.fromXml(getCurrentTask().getStimSpec()).getStimObjIdCount();
//		
//	}
	...
	public void countCorrectTrial(boolean isCorrect){
		...
		//
		System.out.println("RobotExperimentState:countCorrectTrial() : correctTrialCount == " + correctTrialCount);
	...
	public void setAnimationStates(RobotDbUtil dbUtil) {
