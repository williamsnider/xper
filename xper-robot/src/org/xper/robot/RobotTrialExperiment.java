 ...
 * 
 */
public class RobotTrialExperiment implements Experiment {
	static Logger logger = Logger.getLogger(RobotTrialExperiment.class);

	ThreadHelper threadHelper = new ThreadHelper("SlideTrialExperiment", this);

	@Dependency
	RobotExperimentState stateObject;
	...
	public void run() {
		TrialExperimentUtil.run(stateObject, threadHelper, new TrialRunner() {
			public TrialResult runTrial() {
				try {
//					System.out.println("\n\n JK 04225 RobotTrialExperiment : fetching next task");
					// get a task
...
//					System.out.println(stateObject.isDoEmptyTask());
					...
					if (stateObject.getCurrentTask() == null && !stateObject.isDoEmptyTask()) {
						try {
//							System.out.println("JK 01126 RobotTrialExperiment : null task");
							Thread.sleep(SlideTrialExperimentState.NO_TASK_SLEEP_INTERVAL);
						} catch (InterruptedException e) {
						}
						System.out.println("JK 04126 RobotTrialExperiment : TrialResult.NO_MORE_TASKS");
...
//							System.out.println("JK28 RobotTrialExperiment : slidesPerTrial =  " + slidesPerTrial);
...
//									System.out.println("JK 5632 PngTrialExper() runTrial() : cleanupTask ");
	...
	public void setStateObject(RobotExperimentState stateObject) {
