...
import org.xper.robot.drawing.stimuli.PngObject;
import org.xper.robot.drawing.stimuli.PngObjectSpec;
import org.xper.robot.expt.generate.PngGAParams;
import org.xper.robot.expt.generate.RobotStimSpecGenerator;
import org.xper.robot.expt.generate.RobotRandomGeneration.TrialType;
import org.xper.robot.parsedata.DataObject;
import org.xper.robot.util.RobotDbUtil;
import org.xper.time.TimeUtil;


public class RobotExptSpecGenerator implements RobotStimSpecGenerator {
	...
	static public enum StimType { LIBRARY, OBJECT, ENVT, COMPOSITE, STABILITY, PERTURBATION, BALL, SPHERICALSAMPLING, GRASSGRAVITY,GRASSGRAVITYSTIMULUS, OPTICS, MATERIAL, BLOCKINESS, SYMMETRY, DISTANCE, ANIMACY_ANIMATE, ANIMACY_STILL, DENSITY, MASS, BLANK };
...
//		System.out.println(postHoc);
	...
	public RobotExptSpec generateGATrial(List<Long> stimObjIds, String trialType) {
		
		// TRIAL SETUP 
		RobotExptSpec g = new RobotExptSpec(); 	// spec for each trial
