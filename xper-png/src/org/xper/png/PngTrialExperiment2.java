...
public class PngTrialExperiment2 implements Experiment {
	static Logger logger = Logger.getLogger(PngTrialExperiment2.class);
...
//				}
				...
				try {
					...
					if (stateObject.getCurrentTask() == null) {
						try {
							System.out.println("JK26 PngTrialExperiment null task, sleeping");
