...
public class PngExptSpecGenerator implements PngStimSpecGenerator {
	...
	static public enum StimType { OBJECT, ENVT, COMPOSITE, STABILITY, PERTURBATION, BALL, GRASSGRAVITY,GRASSGRAVITYSTIMULUS, OPTICS, MATERIAL, BLOCKINESS, DISTANCE, ANIMACY_ANIMATE, ANIMACY_STILL, DENSITY, MASS, BLANK };
