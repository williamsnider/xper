...
public class PngMathUtil {
	...
	public static double randBoundedGauss(double sigma, double mu, double vMin, double vMax) {
		double out;
		do { out = PngMathUtil.randGauss(sigma,mu);
...
//	    }
	...
	public static boolean anyInBoundingBox(double[][] poly,double[]...pts) {
		...
		double maxX = PngMathUtil.max(0,poly);
		double minX = PngMathUtil.min(0,poly);
		double maxY = PngMathUtil.max(1,poly);
		double minY = PngMathUtil.min(1,poly);
